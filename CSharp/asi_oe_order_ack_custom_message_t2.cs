// ============================================================
// asi_oe_order_ack_custom_message_t2.cs
// ============================================================
// Description : Appends a custom message to the body (memo) of Order
//               Acknowledgment emails, below whatever text is already there.
...
namespace asi_OeOrderAckCustomMessage_t2
{
    public class asi_oe_order_ack_custom_message_t2 : P21.Extensions.BusinessRule.Rule
    {
        ...
        private void LogRule(string logAction, string returnValue, string details)
        {
            try
            {
                ...
                using (SqlCommand logCmd = new SqlCommand(logSql, P21SqlConnection))
                {
                    ...
                    logCmd.Parameters.Add("@Rule", SqlDbType.VarChar, 255).Value = nameof(asi_oe_order_ack_custom_message_t2);
        ...
        {
            return nameof(asi_oe_order_ack_custom_message_t2);
        }
    }
}
