...
//   t10 - Safe column access via Columns.Contains() before reading MessageBoxData fields
// =============================================================================
...
namespace _t10_asi_oe_suppress_oe_msgs
{
    public class _t10_asi_oe_suppress_oe_msgs : P21.Extensions.BusinessRule.Rule
    {
        public override RuleResult Execute()
        {
            ...
            {
                DataColumnCollection cols = msgRow.Table.Columns;
                string messageTitle = cols.Contains("message_title") && !msgRow.IsNull("message_title") ? msgRow.Field<string>("message_title") : null;
                string methodName   = cols.Contains("method_name")   && !msgRow.IsNull("method_name")   ? msgRow.Field<string>("method_name")   : null;
                string userText     = cols.Contains("user_text")     && !msgRow.IsNull("user_text")     ? msgRow.Field<string>("user_text")     : null;
        ...
        public override string GetName() => "_t10_asi_oe_suppress_oe_msgs";
    }
}
