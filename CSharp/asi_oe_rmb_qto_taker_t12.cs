...
//               MessageBox before updating. Posts DynaChange notification
//               on success for immediate user feedback.
...
// Prereq      : asi_oe_qto_session_t3 registered and active
//               asi_session_context table exists in P21 DB
// ============================================================
// CHANGE LOG
// ------------------------------------------------------------
// 2026-06-23  Bus App Team  (T11 -> T12)
//   - Renamed from T11 to T12
//   - Dialog title: "Convert to Order Update"
//   - ruleResult.Message on success for immediate DynaChange notification
// ============================================================
...
namespace asi_OeRmbQtoTaker_t12
{
    public class asi_oe_rmb_qto_taker_t12 : P21.Extensions.BusinessRule.Rule
    {
        ...
        {
            return nameof(asi_oe_rmb_qto_taker_t12);
        }
    }
}
