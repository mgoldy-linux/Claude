...
//   3. Check Exclude from EDI 832 if currently unchecked.
//   4. Check EDI Updated if EDI Last Updated matches today.
//
// On Save (BeforeSave):
...
namespace ASI_IM_Gen_Discontinued_Check_v2
{
    public class ASI_IM_Gen_Discontinued_Check : P21.Extensions.BusinessRule.Rule
    {
        ...
        private const string FLD_EXCLUDE_FROM_EDI832   = "exclude_from_edi832_flag"; // General
        ...
        public override RuleResult Execute()
        {
            ...
            try
            {
                ...
                string excludeFromEdi832 = this.Data.Fields[FLD_EXCLUDE_FROM_EDI832].FieldValue ?? string.Empty;
                if (excludeFromEdi832 != "Y")
                {
                    this.Data.Fields[FLD_EXCLUDE_FROM_EDI832].FieldValue = "Y";
                }
        ...
        public override string GetDescription() =>
            "When Discontinued is checked, auto-populates EDI Discontinued Date, EDI Last Updated, Exclude from EDI 832, and EDI Updated fields.";
