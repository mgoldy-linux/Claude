...
//   - T1: Data.Fields["order_no"].ToString() returned type name
//         "P21.Extensions.BusinessRule.DataField" instead of value
//   - T2: use .Value property to get the actual field value
// ============================================================
...
namespace asi_OeQtoSession_t2
{
    public class asi_oe_qto_session_t2 : P21.Extensions.BusinessRule.Rule
    {
        public override RuleResult Execute()
        {
            ...
            try
            {
                // .Value extracts the actual field value from the DataField object
                object orderNoRaw = this.Data.Fields["order_no"].Value;
        ...
        {
            return nameof(asi_oe_qto_session_t2);
        }
    }
}
