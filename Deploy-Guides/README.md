...
| *(none)* | [90 Day Usage Report — blank subscriptions (Jami Klitzman)](ssrs-90-day-usage-report-blank-subscriptions.md) | 🔵 **Durable fix applied 2026-07-27** (confirmed via `ModifiedDate` batch update, all 44 locations). Jami wants a one-time forced rerun tonight to validate before Sunday — `Invoke-NinetyDayUsageSubscriptions-FireTonight.ps1` built 2026-07-28, **not yet run**. 5 new branches reported (Naperville, St. Cloud, Omaha, Wixom, Ft Wayne) still not individually checked |
