...
| Ticket | Title | Status |
|--------|-------|--------|
| *(none)* | [Order Acknowledgment Custom Email Message](order-ack-custom-email-message.md) | 🔴 **Blocked/paused.** t2 active in P21 Business Rules only (confirmed via SQL); t3 (adds leading blank lines) built but not registered. ⚠️ t1 caused a real-customer email incident during testing (4 customers, see guide) — apologies sent, closed. Next: register t3, test with a controlled recipient |
