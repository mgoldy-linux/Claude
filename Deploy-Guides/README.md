...
| *(none)* | [90 Day Usage Report — blank subscriptions (Jami Klitzman)](ssrs-90-day-usage-report-blank-subscriptions.md) | 4 of ~44 subscriptions (162, 241, 261, 400) had a corrupted `mfg` parameter — **fixed and verified 2026-07-23**. A separate, unresolved intermittent zero-row render bug affects other branches; root cause still open after ruling out caching and a false `kb_`-connection lead. Recommended NULL-guard query fix not yet applied. **Awaiting Jami's feedback** on next occurrence |
