...
where print_date > dateadd(day,datediff(day,30,GETDATE()),0)  and a.order_no = 1452113 
...
join p21_view_ord_ack_hdr b
on ol.order_no = b.order_no
where print_date > dateadd(day,datediff(day,60,GETDATE()),0) and a.order_no = 1452113 
