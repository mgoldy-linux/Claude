...
update company set company_name = left('** Lockbox **', 40)
update alert_implementation set row_status_flag = 705

update company set company_name = left('** LOCKbox 20240315 **', 40)
update location set location_name = left('*** LOCKbox 20240315 **** ' + location.location_name + ' *** HQ ***', 255) where location_id = 100
update branch set branch_description = left('*** LOCKbox 20240315 **** ' + branch_description + ' ***  Acc ***', 40)
