/*
			  ...
			  last update 08/23/2021, 10/26/2021, 03/12/2022
*/
...
set @filename = 'E:\SQL\Backup\p21_prod_to_play20220312.bak'
...
Disk = @filename
with replace 
, move 'seed16_Data' to 'E:\SQL\Data\P21Play20220312.mdf'
, move 'seed16_Log' to 'E:\SQL\Data\P21Play20220312.ldf'
...
update company set company_name = left('*** P21Play Copied 03/12/22 ***', 40)
