select customer_id[Customer Id],co.id[contact id],c.default_branch_id[Default Branch Id],salesrep_id[Salesrep ID],customer_name[Name],
case
...
where c.company_id = '1' and web_enabled_flag = 'Y' and c.delete_flag = 'N' and co.delete_flag = 'N'
