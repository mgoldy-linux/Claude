select
c.customer_id,
CASE shipping_address WHEN 'Y' THEN convert(varchar,c.customer_id) ELSE '' END as sequence,
c.credit_limit,
c.terms_id,
customer_name,
...
where c.company_id = '1' and web_enabled_flag = 'Y' --or (c.default_branch_id = 300 and a.phys_country = 'CA')
