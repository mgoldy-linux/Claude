...
where class_1id not in ('IPTCI','LMS','PTI') and invoice_date between @StartDate and @EndDate and branch_id = @Branch /*and product_group_id not in ('OTHERCHG','Null')*/ and qty_shipped != 0 and invoice_line_type = 0