...
Select '220'[Record Type],a.id[External ID],
case 
...
from po_hdr ph
join address a
on ph.location_id = a.id
where po_no in (4013889,4013545,4013872,4013104,4013423,4012437,4013417,4012410,4013416,4013510,4013016,4013137,4011341,4013508,4013566,4013351,4012998,4013248,4013389,4013004,4013053,4013566,4012729,4013015,4013508,4013014,4013105,4013045,4011435,4012766,4013053,4011341,4013280)
/*
select *
from po_hdr
where po_no = 4013889
