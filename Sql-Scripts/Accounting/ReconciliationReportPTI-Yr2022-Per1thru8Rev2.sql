...
(
	...
	where b.date_created > '2021-07-01' and gl.account_number = 14010000100 and gl.year_for_period = 2022 and gl.period between 1 and 8
	...
	select distinct gr.receipt_number,i.inv_mast_uid,i.item_id,gr.voucher_number,i.invoice_number,i.journal_id,i.period,i.year_for_period,i.Inventory,iii.InventoryInterim,irpc.PurchasesClearing,itt.InventoryinTransit,irlc.LandedCost
	from getRecords gr
