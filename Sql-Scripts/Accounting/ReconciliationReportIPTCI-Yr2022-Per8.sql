...
(
	...
	where b.date_created > '2021-07-01' and gl.account_number = 14010000300 and gl.year_for_period = 2022
	),
	...
	select gr.receipt_number,gr.voucher_number,i.invoice_number,i.journal_id,i.period,i.year_for_period,i.Inventory,iii.InventoryInterim,irpc.PurchasesClearing,itt.InventoryinTransit,irlc.LandedCost
	from getRecords gr
	...
	where i.journal_id is not null and i.year_for_period = 2022 and i.period = 8
/*	union
	with getRecords (receipt_number, voucher_number)
as
(
