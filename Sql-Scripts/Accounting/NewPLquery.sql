...
Declare @period int;
Declare @period_year datetime;


set @StartDate= '09/01/2019'
set @zendDate = '09/30/2019'
set @period = 3;
set @period_year = 2020
...
account_desc,g.amount,a.branch_id,a.company_no,Month(transaction_date) Mth, Year(transaction_date) Year--, g.period, g.year_for_period
...
and a.company_no = 1 and g.period = @period --and g.year_for_period = @period_year
/*
