...
set @sortDate = '_' + @yearNum + @sortMonth + @dayNum

set @fileNames = 'C:\SQL_Out\Sales-Summary-Industrial-Components' + @sortDate + '.xlsx' 
...
EXEC msdb.dbo.sp_send_dbmail
      ...
      --@copy_recipients = 'rlinke@solveindustrial.com',
