...
declare @dayNum as varchar(3),
 ...
 -- set subject Name 
 set @SubName = 'Nightly Inside Sales KPI Report for  '
...
--set @fileNames = 'C:\SQL_Out\InsideSales_KPI_' + @sortDate + '.xlsx' 

set @Subject = @SubName + @fullDate  + '.'
set @bodyText = 'Daily summary report for your review.'

EXEC msdb.dbo.sp_send_dbmail
      @profile_name = 'P21Alerts',
      @recipients = 'mark.goldyn@solveindustrial.com',
