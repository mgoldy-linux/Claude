...
select @Opcount18353 = COUNT(*) from d_Open_Quote_Summary where SalesRepName like '%18353%'
...
if @Qcount18353 >= 1 or @Opcount18353 >= 1
Begin
	set @fileNames = 'C:\SQL_Out\TPW-Inc_18353_Open_Orders_Quotes_' + @sortDate + '.xlsx' 
End
else
Begin 
	set @fileNames = ''	
	set @QuoteTable = '' 
	set @OrderTable =  ''
	set @noQuoteFound = 'No Open Quotes Found for TPW.'
End
