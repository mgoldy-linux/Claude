...
select @count1025 = COUNT(*) from d_Open_Quote_Summary where SalesRepName like '%25%'
...
if @count1025 = 1 
Begin
	set @fileNames = 'C:\SQL_Out\Simpson-Associates_1025_Open_Quotes_' + @sortDate + '.xlsx' 
End
else
Begin 
	set @fileNames = ''	
	set @noQuoteFound = 'No Quotes Found.'
End
...
set @bodyText = @bodyTable + @noQuoteFound
