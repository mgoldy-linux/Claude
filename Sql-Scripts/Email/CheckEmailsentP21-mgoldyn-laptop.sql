...
select importance,recipients,subject,sent_date,sent_status,copy_recipients,blind_copy_recipients,body_format
from msdb.dbo.sysmail_mailitems
where copy_recipients like '%@ProPowerReps.com%' and sent_date > '2024-03-01' 

-- recipients
select importance,recipients,subject,sent_date,sent_status,copy_recipients,blind_copy_recipients,body_format
from msdb.dbo.sysmail_mailitems
where recipients like  '%@ProPowerReps.com%' and sent_date > '2024-03-01' 
...
select importance,recipients,subject,sent_date,sent_status,copy_recipients,blind_copy_recipients,body_format
from msdb.dbo.sysmail_mailitems
where recipients like '%james%' and sent_date > '2023-12-13'
order by subject -- sent_date desc

-- between dates
select importance,recipients,subject,sent_date,sent_status,copy_recipients,blind_copy_recipients,reply_to,from_address
from msdb.dbo.sysmail_mailitems
where sent_date between '2023-12-15 18:00:00.000' and '2023-12-16'
order by sent_date desc