/*
	...
	08/11/22 - add loftus@bearingslimited.com per gdib
*/
Use P21;
...
select @Subject = 'Daily Orders Summary for Former Rausch Sales (1027) Territory for ' + @fullDate
...
Waitfor delay '00:00:05'
 ...
 EXEC msdb.dbo.sp_send_dbmail
      ...
      @recipients = 'loftus@bearingslimited.com',
