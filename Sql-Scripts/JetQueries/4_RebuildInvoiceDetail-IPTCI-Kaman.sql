-- 03/11/2022 clark --	Kaman for IPTCI
-- For Clark FY21 & 22
-- 07/11/2022  - Price 7
use P21;
...
where class_2id in ('Kaman') and invoice_date between @StartDate and @EndDate and branch_id = @Branch and product_group_id not in ('OTHERCHG','Null') and qty_shipped != 0 and invoice_line_type = 0
