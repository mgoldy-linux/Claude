...
where (class_1id not in ('IPTCI','LMS','PTI') or class_1id is null) and invoice_date between @StartDate and @EndDate and branch_id like '4%' and product_group_id not in ('OTHERCHG','Null') and qty_shipped != 0 and invoice_line_type = 0
