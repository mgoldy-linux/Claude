-- 03/11/2022 clark --	Transply for PTI
-- For Clark FY21 & 22
-- 07/11/2022  - Price 7
...
where class_2id in ('Transply') and invoice_date between @StartDate and @EndDate and branch_id = @Branch and product_group_id not in ('OTHERCHG','Null') and qty_shipped != 0 and invoice_line_type = 0
