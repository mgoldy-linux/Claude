-- ============================================================
-- Portal: Purchasing BOP Supplier Manager
...
-- SA 45138: bo_orders_cte — open sales order numbers for items with qty_backordered > 0
...
-- SA 45138: critical_orders_cte — open sales order numbers for items with net_avail < 0
...
SELECT
    ...
    , bo.bo_orders          -- SA 45138: open order numbers for backordered items
    , SUM(m.critical) critical
    , co.critical_orders    -- SA 45138: open order numbers for critical items (net_avail < 0)
     , l.last_po
FROM item_req_cte c
...
HAVING
    bo.bo_orders IS NOT NULL        -- SA 45138: suppress stale qty_backordered rows with no active lines
