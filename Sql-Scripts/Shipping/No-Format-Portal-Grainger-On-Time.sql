...
end[Days Late/Early],convert(varchar(10),oh.order_date,120)[order_date],opt.print_date,opt.ship_date,(DATEDIFF(MINUTE,opt.print_date,opt.ship_date))/60
...
WHERE ih.company_no = '1' AND c.customer_id in (54210,54533,113521) AND ih.invoice_date >= DATEADD(day, -90, current_timestamp) -- oh.order_no = 1538243 ---   
