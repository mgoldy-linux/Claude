-- error message null - error messages point to carrier  - wrong weight

use Quickship;

select *
from Quickship.dbo.[Order]
where ErpKey = '1332087'

select ShipToAddressId,*
from Shipment
where OrderReference = '1318194' -- and ShipmentTrackingnumber = '1Z766E550397479208'
