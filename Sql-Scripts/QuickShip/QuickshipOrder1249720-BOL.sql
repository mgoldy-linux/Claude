-- BOL error Specified argument was out of the range of valid values - most likely 0 value for price
use Quickship;

select *
from Quickship.dbo.[Order]
where ErpKey = '1249720'

select AllocatedValue,*
from Shipment
where OrderReference = '1249720' and ReleaseIdentification = 2203548 --and ShipmentTrackingnumber = '1Z766E550397479208'  -- no tracking no because bol will not print
