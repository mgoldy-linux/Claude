...
where ErpKey = '1320527'

select ActualFreightCharges,BillableFreightCharges,LTLFreighted,ShipToAddressId,ShipmentExportId
from Shipment
where OrderReference = '1320527' -- and ShipmentTrackingnumber = '1Z766E550397479208'

select FreightAmount,FreightForwarderAddressId,FreightForwarderPhone,FreightForwarderTaxIdentification,FreightOverridden
from ShipmentExport
where ShipmentExportId = '4A29A38B-057B-4388-AC0C-AF9A014491E1'
