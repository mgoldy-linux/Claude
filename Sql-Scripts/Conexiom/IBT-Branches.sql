...
where c.class_3id in ('IBT','MAGNUM')  and c.delete_flag = 'N'
order by phys_postal_code


select customer_name,default_branch_id,class_3id,*
from dbo.customer
where customer_name like '%IBT%' and delete_flag = 'N'

-- 2575
select *
from dbo.ship_to
where customer_id = 11557