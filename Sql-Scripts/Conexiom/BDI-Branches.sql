/*
	class_2id in ('BDI','BDI-CAN','BDI-MS')
*/
...
where c.class_2id in ('BDI','BDI-CAN','BDI-MS') and c.delete_flag = 'N' and co.delete_flag = 'N' and a.delete_flag = 'N' and sh.delete_flag = 'N'
