/*
	03/25/2020 - created per phone conversation with Olivia
...
/*
if OBJECT_ID ('A_oe_pick_tickets_shipped_Olivia', 'V') is not null
drop view A_oe_pick_tickets_shipped_Olivia;
go

create view [dbo].[A_oe_pick_tickets_shipped_Olivia] AS
*/
...
where a.invoice_no is null and a.c_tracking_no is not null and a.c_tracking_no != '* * CANCELLED * *'
