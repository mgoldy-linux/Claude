/*
		...
		09/12/2022 - change unknown to unassigned, 05/12/23 add back in primary salesrep
*/
--use P21Play;
--use P21;
...
(
	...
	case when ship2_zip is null then '55555' else ship2_zip end,
