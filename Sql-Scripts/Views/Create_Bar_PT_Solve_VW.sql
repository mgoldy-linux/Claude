...
end [LogoBrand],default_product_group,pf.price_family_id,format(print_quantity,'N0')[Qty2Print]--,customer_id
from oe_hdr h
join oe_line l
...
where p.location_id = 100 and h.completed = 'N' and projected_order = 'N' and l.delete_flag = 'N' and l.detail_type = 0 and default_product_group not in ('OTHERCHG','D1') and h.rma_flag = 'N' and p.delete_flag = 'N' and p.invoice_no is null 
