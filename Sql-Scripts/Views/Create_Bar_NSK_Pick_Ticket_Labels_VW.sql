...
--use P21;
/*
if OBJECT_ID ('Bar_NSK_Pick_Ticket_Labels_VW', 'V') is not null
drop view Bar_NSK_Pick_Ticket_Labels_VW;
go

create view [dbo].[Bar_NSK_Pick_Ticket_Labels_VW] AS
*/
...
where customer_id = 12990 and h.completed = 'N' and pth.delete_flag = 'N' and h.delete_flag = 'N' and pth.delete_flag = 'N'

go 
/*
grant select,update,references on object::Bar_NSK_Pick_Ticket_Labels_VW to p21_application_role
grant select,update,references on object::Bar_NSK_Pick_Ticket_Labels_VW to PxxiUser
grant select,update,references on object::Bar_NSK_Pick_Ticket_Labels_VW to [PTIDOM\P21Users]
*/