...
FROM            P21.dbo.p21_view_invoice_line AS invoice_line LEFT OUTER JOIN
                         ...
                         P21.dbo.oe_pick_ticket_detail AS oept ON oept.pick_ticket_no = oe_pick_ticket.pick_ticket_no AND oept.invoice_line_uid = invoice_line.invoice_line_uid LEFT OUTER JOIN
                         ...
                         P21.dbo.oe_line_schedule AS ols ON ols.order_no = invoice_line.order_no AND ols.line_no = invoice_line.oe_line_number AND ols.release_no = oept.release_no LEFT OUTER JOIN
                         ...
                         P21.dbo.inv_mast_ud AS iud WITH (nolock) ON iud.inv_mast_uid = inv_mast.inv_mast_uid LEFT OUTER JOIN
                         ...
                         P21.dbo.class AS oe_hdr_class2 WITH (nolock) ON oe_hdr.class_2id = oe_hdr_class2.class_id AND oe_hdr_class2.class_number = 2 AND oe_hdr_class2.class_type = 'oe' AND oe_hdr_class2.delete_flag = 'n' LEFT OUTER JOIN
                         P21.dbo.class AS oe_hdr_class3 WITH (nolock) ON oe_hdr.class_3id = oe_hdr_class3.class_id AND oe_hdr_class3.class_number = 3 AND oe_hdr_class3.class_type = 'oe' AND oe_hdr_class3.delete_flag = 'n' LEFT OUTER JOIN
                         P21.dbo.class AS oe_hdr_class4 WITH (nolock) ON oe_hdr.class_4id = oe_hdr_class4.class_id AND oe_hdr_class4.class_number = 4 AND oe_hdr_class4.class_type = 'oe' AND oe_hdr_class4.delete_flag = 'n' LEFT OUTER JOIN
                         P21.dbo.class AS oe_hdr_class5 WITH (nolock) ON oe_hdr.class_5id = oe_hdr_class5.class_id AND oe_hdr_class5.class_number = 5 AND oe_hdr_class5.class_type = 'oe' AND oe_hdr_class5.delete_flag = 'n' LEFT OUTER JOIN
                         ...
                         P21.dbo.supplier_ud AS supplier_ud WITH (nolock) ON supplier_ud.supplier_id = inv_loc.primary_supplier_id
