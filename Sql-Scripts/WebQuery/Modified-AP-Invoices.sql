...
SELECT apinv_hdr.voucher_no, apinv_hdr.invoice_no[CP'S Invoice],m.item_id,ff.qty_received,ff.fifo_layer_qty[QtyOpen],ff.cost,
...
FROM            P21.dbo.apinv_hdr AS apinv_hdr WITH (nolock) 
				...
				on po.po_no = pl.po_no and apinv_hdr.po_no = pl.po_no
...
Where apinv_hdr.invoice_no like 'CP%'--and item_id in ('2101034317','2101034666','2101034925') and  apinv_hdr.invoice_no ='CP220306-05B/6'--and  item_id = '39A080001'